...
сообщение.Добавьте возможность хранения файла данных
в домашнем каталоге пользователя. Для выполнения операций с файлами
необходим использовать модуль pathlib .
"""
